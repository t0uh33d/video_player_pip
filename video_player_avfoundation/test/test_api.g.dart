...
abstract class TestHostVideoPlayerApi {
  ...
  void setAutomaticallyStartPictureInPicture(AutomaticallyStartPictureInPictureMessage msg);
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.setAutomaticallyStartPictureInPicture was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final AutomaticallyStartPictureInPictureMessage? arg_msg = (args[0] as AutomaticallyStartPictureInPictureMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.setAutomaticallyStartPictureInPicture was null, expected non-null AutomaticallyStartPictureInPictureMessage.');
          api.setAutomaticallyStartPictureInPicture(arg_msg!);
          return <Object?>[];
        });
      }
    }
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.pipPlay was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final TextureMessage? arg_msg = (args[0] as TextureMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.pipPlay was null, expected non-null TextureMessage.');
          api.pipPlay(arg_msg!);
          return <Object?>[];
        });
      }
