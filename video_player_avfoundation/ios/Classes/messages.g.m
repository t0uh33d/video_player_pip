...
+ (FLTAutomaticallyStartPictureInPictureMessage *)fromList:(NSArray *)list;
+ (nullable FLTAutomaticallyStartPictureInPictureMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FLTSetPictureInPictureOverlayRectMessage ()
+ (FLTSetPictureInPictureOverlayRectMessage *)fromList:(NSArray *)list;
+ (nullable FLTSetPictureInPictureOverlayRectMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FLTPictureInPictureOverlayRect ()
+ (FLTPictureInPictureOverlayRect *)fromList:(NSArray *)list;
+ (nullable FLTPictureInPictureOverlayRect *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
  ...
  FLTAutomaticallyStartPictureInPictureMessage* pigeonResult = [[FLTAutomaticallyStartPictureInPictureMessage alloc] init];
  pigeonResult.textureId = textureId;
...
+ (nullable FLTAutomaticallyStartPictureInPictureMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTAutomaticallyStartPictureInPictureMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.textureId ?: [NSNull null]),
...
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
  ...
  FLTSetPictureInPictureOverlayRectMessage* pigeonResult = [[FLTSetPictureInPictureOverlayRectMessage alloc] init];
  pigeonResult.textureId = textureId;
...
+ (FLTSetPictureInPictureOverlayRectMessage *)fromList:(NSArray *)list {
  ...
  pigeonResult.textureId = GetNullableObjectAtIndex(list, 0);
  NSAssert(pigeonResult.textureId != nil, @"");
  pigeonResult.rect = [FLTPictureInPictureOverlayRect nullableFromList:(GetNullableObjectAtIndex(list, 1))];
  return pigeonResult;
}
+ (nullable FLTSetPictureInPictureOverlayRectMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTSetPictureInPictureOverlayRectMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.textureId ?: [NSNull null]),
...
+ (nullable FLTPictureInPictureOverlayRect *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTPictureInPictureOverlayRect fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    case 128: 
      return [FLTAutomaticallyStartPictureInPictureMessage fromList:[self readValue]];
    case 129: 
    ...
    case 132: 
      return [FLTPictureInPictureOverlayRect fromList:[self readValue]];
    case 133: 
      return [FLTPlaybackSpeedMessage fromList:[self readValue]];
    case 134: 
      return [FLTPositionMessage fromList:[self readValue]];
    case 135: 
      return [FLTSetPictureInPictureOverlayRectMessage fromList:[self readValue]];
    case 136: 
...
void FLTAVFoundationVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setPictureInPictureOverlayRect"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setPictureInPictureOverlayRect:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(setPictureInPictureOverlayRect:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setAutomaticallyStartPictureInPicture"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutomaticallyStartPictureInPicture:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(setAutomaticallyStartPictureInPicture:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.pipPlay"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(pipPlay:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(pipPlay:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTTextureMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api pipPlay:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
