...
- (void)setAutomaticallyStartPictureInPicture:(FLTAutomaticallyStartPictureInPictureMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)pipPlay:(FLTTextureMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
